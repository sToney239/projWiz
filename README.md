...
The goal of projWiz is to create an R version of [Projection
Wizard](https://projectionwizard.org/), which is an interactive web
application helping select an appropriate map projection.
