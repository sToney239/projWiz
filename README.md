...
decide projective coordinate system based on R geospatial objects.

Please note that the projection generated by this package largely
depends on the geographical extent you provide. Therefore the projection
can be highly customized, and may not be suitable for large-scale
projects or formal collaborations (official projections are recommended
in such cases). However, for personal map-making seeking to maintain
accuracy and convenience, projWiz could work.
