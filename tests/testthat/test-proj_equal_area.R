test_that("proj_equal_area works", {
  ...
  expect_error(proj_equal_area(sf::st_bbox(c(xmin = 2,ymin = -23,xmax = 170 ,ymax = -1),crs = 4326)))
  ...
  expect_error(proj_equal_area(sf::st_bbox(c(xmin = 52,ymin = 42,xmax = -132 ,ymax = 55),crs = 4326)))
 ...
 UNIT["Meter",1.0]]')
  ...
  expect_error(proj_equal_area(c(xmin = 2,ymin = -23,xmax = 190 ,ymax = -1)))
})
