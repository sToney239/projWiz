---
title: "Regional Projection Selection Procedure"
editor_options: 
  markdown: 
    wrap: 72
---
...
![Illustration of the extreme conditions that can lead to errors when the longitude spans too widely. The green area is the area of interest (Note the flaw in the top center of the map)](images/conicFlaw.jpg)
...
![Hey, how could I be wrong, if I'm so flexible to set the center point, the neighborhood area must have little distortion (https://desktop.arcgis.com/en/arcmap/latest/map/projections/projection-types.htm)](images/azimuthalProj.jpg)
...
![Help you to imagine a conical hat on the earth(https://desktop.arcgis.com/en/arcmap/latest/map/projections/projection-types.htm)](images/conicProj.jpg)
...
About these two conic projections, specifying them usually requires two latitude parameters, usually called as "standard parallels." The trick is to set these parallels at [1/6 and 5/6](https://api.semanticscholar.org/CorpusID:203636100) of the latitudinal extent.

## Step 3: Other Projection Suggestions


Actually, this step was not in my plan when starting this package, but I found it relatively easy to implement (but met problems of the irregular grid of the UTM zones :rage:). It's about calculating the zone number for UTM or Gauss-Kruger projections. It would is a good point of reference since these projections are often with something like EPSG codes and easy to share.
...
![Irregular grid of UTM Zone](images/irregularGrid.jpg)
